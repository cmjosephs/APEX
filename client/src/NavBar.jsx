...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        backgroundColor: theme.palette.mode === 'dark' ? '#E7E7E7' : '#E7E7E7',
      },
    },
  },
  '& .MuiSwitch-thumb': {
    backgroundColor: theme.palette.mode === 'dark' ? '#D6CCC2' : '#D6CCC2',
    width: 32,
    height: 32,
    '&:before': {
      content: "''",
...
const NavBar = ({ themeToggler }) => {
  ...
  return (
    <div>
      <FormGroup>
      <FormControlLabel
        control={<MaterialUISwitch sx={{ m: 1 }} defaultChecked onChange={themeToggler}/>}
        label=""
